...
% Choose font
\usepackage[sfdefault,thin]{roboto}  %% sfdefault if the base font of the document is sans serif
...
{\begin{tikzpicture}[remember picture,overlay]
    ...
    \filldraw [x=1mm,y=1mm, titleblue, overlay] (210,-9) -- (100 ,-9) arc (-90:-270:9) --(100,9)
    -- (210,9) (118, 0) node{\color{white} Capítulo \thechapter} (105,-27);
  \end{tikzpicture}
} % before title
[\vspace{3cm} \hfill {\color{mygreen} #1}] % after title
