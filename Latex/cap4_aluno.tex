...
\begin{center}
  \begin{longtable}{|m{0.30\textwidth}|m{0.2\textwidth}|m{0.2\textwidth}|m{0.2\textwidth}|}
    \hline
...
\begin{imagem*}[breakable]{}{}   FIGURA GEOMÉTRICA - Este retângulo tem que ter dimensões compatíveis com os retângulos da tabela. Atenção: Há figuras no   ``Para o professor''   e na   ``Resposta''  .  
    ...
    \includegraphics[width=240pt, keepaspectratio]{../../livro/media//cap4/secoes/fita-regiao-cinza.jpg}  
\end{imagem*}
...
\begin{center}
  \begin{longtable}{|m{.3\textwidth}|m{.2\textwidth}|m{.2\textwidth}|m{.2\textwidth}|}
    \hline \hline
    ...
    \hline
     \includegraphics[height=30pt, keepaspectratio]{../../livro/media//cap4/secoes/fita-um-meio.jpg}  &  &  &  \\
    \hline
     \includegraphics[height=30pt, keepaspectratio]{../../livro/media//cap4/secoes/fita-um-quarto.jpg}  &  &  &  \\
    \hline
     \includegraphics[height=30pt, keepaspectratio]{../../livro/media//cap4/secoes/fita-um-sexto.jpg}  &  &  &  \\
    \hline
     \includegraphics[height=30pt, keepaspectratio]{../../livro/media//cap4/secoes/fita-um-oitavo.jpg}  &  &  &  \\
    \hline
     \includegraphics[height=30pt, keepaspectratio]{../../livro/media//cap4/secoes/fita-um-decimo.jpg}  &  &  &  \\
    \hline
     \includegraphics[height=30pt, keepaspectratio]{../../livro/media//cap4/secoes/fita-um-dezesseis-avos.jpg}  &  &  &  \\
    \hline
  \end{longtable}
\end{center}
...
\end{enumerate} %d
\begin{imagem*}[breakable]{}{}   FIGURA GEOMÉTRICA - também tem figura na resposta.  \mbox{} \newline        \includegraphics[width=\textwidth,height=4cm, keepaspectratio]{../../livro/media//cap4/secoes/fractions-01.jpg}   \end{imagem*}
\begin{enumerate} [\quad I)] %d
...
\begin{imagem*}[breakable]{}{}   FIGURA GEOMÉTRICA  
    \includegraphics[width=360pt, keepaspectratio]{../../livro/media//cap4/secoes/w_9.png}  
\end{imagem*}
...
\begin{imagem*}[breakable]{}{}   FIGURA GEOMÉTRICA  
    \includegraphics[width=360pt, keepaspectratio]{../../livro/media//cap4/secoes/w_10.png}  
\end{imagem*}
...
\begin{imagem*}[breakable]{}{}   FIGURA GEOMÉTRICA  
    \includegraphics[width=360pt, keepaspectratio]{../../livro/media//cap4/secoes/w_11.png}  
\end{imagem*}
...
\begin{imagem*}[breakable]{}{}   FIGURA GEOMÉTRICA  
    \includegraphics[width=360pt, keepaspectratio]{../../livro/media//cap4/secoes/w_12.png}  
\end{imagem*}
...
Você tem um copo cilíndrico graduado com cinco marcas horizontais igualmente espaçadas. O copo tem suco de laranja até $\frac{3}{4}$ de sua capacidade, como ilustra a imagem:\includegraphics[width=30pt, keepaspectratio]{../../livro/media//cap4/secoes/equivalencia-copo-01.png}. Seu colega tem um copo cilindrico idêntico, mas graduado com 17 níveis horizontais igualmente espaçados: \includegraphics[width=30pt, keepaspectratio]{../../livro/media//cap4/secoes/equivalencia-copo-01-vazio-resposta.jpg}.  
...
\begin{imagem*}[breakable]{}{}   FIGURA GEOMÉTRICA  
    ...
    \includegraphics[width=42pt, keepaspectratio]{../../livro/media//cap4/secoes/panquecas-24.png}  
    \includegraphics[width=42pt, keepaspectratio]{../../livro/media//cap4/secoes/panquecas-24.png}  
    \includegraphics[width=42pt, keepaspectratio]{../../livro/media//cap4/secoes/panquecas-24.png}  
    \includegraphics[width=42pt, keepaspectratio]{../../livro/media//cap4/secoes/panquecas-24.png}  
    \includegraphics[width=42pt, keepaspectratio]{../../livro/media//cap4/secoes/panquecas-24.png}  
...
\begin{imagem*}[breakable]{}{}   FIGURAS GEOMÉTRICAS - Há figuras em   ``Para o professor''  .  
    \includegraphics[width=240pt, keepaspectratio]{../../livro/media//cap4/secoes/caminho.jpg}  
\end{imagem*}
