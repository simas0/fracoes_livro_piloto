...
\begin{center}
  \begin{longtable}{|m{.35\textwidth}|m{.16\textwidth}|m{.16\textwidth}|m{.16\textwidth}|}
    ...
    \hline \hline 
    \endhead
    \includegraphics[width=120pt, keepaspectratio]{../../livro/media//cap4/secoes/PNGs/ativ2_fig01.png}      & $$3$$  & $$10$$   & $$\dfrac{3}{10}$$       \\
    \hline
     \includegraphics[width=120pt, keepaspectratio]{../../livro/media//cap4/secoes/PNGs/ativ2_fig02.png}                                                                              & &  &  \\
    \hline
     \includegraphics[width=120pt, keepaspectratio]{../../livro/media//cap4/secoes/PNGs/ativ2_fig03.png}     &  &   &  \\
    \hline
     \includegraphics[width=120pt, keepaspectratio]{../../livro/media//cap4/secoes/PNGs/ativ2_fig04.png} & &&\\
    \hline
     \includegraphics[width=120pt, keepaspectratio]{../../livro/media//cap4/secoes/PNGs/ativ2_fig05.png}  &                                     &                                  &                                                   \\
    \hline
     \includegraphics[width=120pt, keepaspectratio]{../../livro/media//cap4/secoes/PNGs/ativ2_fig06.png} &                                     &                                  &                                                   \\
    \hline
  \end{longtable}
\end{center}
...
\begin{center}
\includegraphics[width=.65\textwidth, keepaspectratio]{../../livro/media/cap4/secoes/PNGs/ativ4_fig01.png}
\end{center}
...
\begin{center}
\includegraphics[width=.3\textwidth, keepaspectratio]{../../livro/media/cap4/secoes/PNGs/ativ4_fig02.png}
\end{center}
