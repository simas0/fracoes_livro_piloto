...
\begin{center}
    \begin{tabular}{m{.085\textwidth}m{.085\textwidth}m{.08\textwidth}m{.08\textwidth}}
...
&  $$\dfrac{1}{6}$$ \\
    ...
    \hline
     \centering $\dfrac{9}{10}$  & \centering \begin{tikzpicture}[x=1mm,y=1mm]
...
\begin{center}
  \begin{tabular}{|m{0.05\textwidth}|m{0.1\textwidth}|m{0.25\textwidth}|}
    \hline 
     \centering Fração  & \centering  Figura da fração  & \quad \quad \quad Uma unidade possível  \\
    \hline \hline 
