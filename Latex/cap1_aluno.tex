...
Três amigos vão repartir uma barra de chocolate. Um deles sugere a seguinte divisão: 
  ...
  \begin{center}
    \includegraphics[width=300pt, keepaspectratio]{../../livro/media/cap1/secoes//pngs_licao_01/ativ1_fig01.png}  
  \end{center}
...
\begin{enumerate} [\quad a)] %s
  ...
  \item     Use a imagem a seguir para mostrar uma divisão da barra de chocolate que permita que os 3 amigos recebam quantidades iguais de chocolate. 
    \begin{center}
    \includegraphics[width=100pt, keepaspectratio]{../../livro/media/cap1/secoes/pngs_licao_01/ativ1_fig02a.png}  
  \end{center}
...
Três pizzas inteiras, de mesmo tamanho, foram repartidas entre as crianças de uma turma. Para isso, a turma foi dividida em três grupos com quatro crianças cada. Veja como cada grupo repartiu a sua pizza.
  ...
  \begin{center}
    \includegraphics[width=400pt, keepaspectratio]{../../livro/media/cap1/secoes/pngs_licao_01/ativ2_fig01.png}
    
    \includegraphics[width=300pt, keepaspectratio]{../../livro/media/cap1/secoes/pngs_licao_01/ativ2_fig02.png}  
  \end{center}
...
\begin{center}
    \includegraphics[width=400pt, keepaspectratio]{../../livro/media/cap1/secoes/pngs_licao_01/ativ3_fig01.png}  
  \end{center}
...
\begin{center}
    \includegraphics[width=300pt, keepaspectratio]{../../livro/media/cap1/secoes/pngs_licao_01/orgideias_fig01.png}  
  \end{center}
...
\begin{center}
    \includegraphics[width=400pt, keepaspectratio]{../../livro/media/cap1/secoes/pngs_licao_01/orgideias_fig02.png}  
  \end{center}
...
\begin{center}
    \includegraphics[width=300pt, keepaspectratio]{../../livro/media/cap1/secoes/pngs_licao_01/orgideias_fig03.png}  
  \end{center}
...
\begin{center}
    \includegraphics[width=100pt, keepaspectratio]{../../livro/media/cap1/secoes/pngs_licao_01/orgideias_fig04.png}  
  \end{center}
...
\begin{center}
    \includegraphics[width=400pt, keepaspectratio]{../../livro/media/cap1/secoes/pngs_licao_01/orgideias_fig05.png}  
  \end{center}
\clearpage
...
\begin{refletindo*}[breakable]{}{}  
  ...
  \noindent\begin{tabular}{ll}
    \includegraphics[width=220pt, keepaspectratio]{../../livro/media/cap1/secoes/pngs_licao_01/reflet_fig01.png} & \includegraphics[width=180pt, keepaspectratio]{../../livro/media/cap1/secoes/pngs_licao_01/reflet_fig02.png}
  \end{tabular}
  \vspace{1cm}
  
  \noindent  \noindent\begin{tabular}{ll}
    \includegraphics[width=180pt, keepaspectratio]{../../livro/media/cap1/secoes/pngs_licao_01/reflet_fig03.png}   & \includegraphics[width=200pt, keepaspectratio]{../../livro/media/cap1/secoes/pngs_licao_01/reflet_fig04.png}  
  \end{tabular}
...
\includegraphics[scale=.6]{paralelepipedo_tercos}
}
...
\begin{enumerate} [\quad a)] %s
  ...
  \begin{center}
 \begin{tikzpicture}[x=1mm,y=1mm]  \draw[fill=common, fill opacity=.3] (0,0) rectangle (20,20);  \end{tikzpicture}  
  \end{center}
...
Identifique as figuras em que a parte pintada em vermelho é a metade da figura.
...
\begin{enumerate}[a)]
  ...
  \item  Qual é fração do círculo preto é maior, um terço ou um sétimo. Explique a sua resposta.
  \item  Qual é fração do círculo preto é menor, um nono ou um quarto. Explique a sua resposta.
  \item  Qual é fração do círculo preto é menor, um quinto ou um sétimo. Explique a sua resposta.
  \item  Qual é fração do círculo preto é maior, um oitavo ou um quarto. Explique a sua resposta.
  \item  Qual é fração do círculo preto é maior, um sexto ou um sétimo. Explique a sua resposta.
\end{enumerate}

\subsection{Atividade}

Nas figuras a seguir, um mesmo círculo azul aparece diferentemente dividido em partes iguais. 
\begin{enumerate} [\quad a)] %s
...
\parbox[t][2cm][c]{2cm}{
\begin{tikzpicture}[scale=5]
 \draw[fill=common, fill opacity=.3] (0,1) rectangle (2,3);
 \draw[fill=attention] (0,0) rectangle (2,1);
\end{tikzpicture} }
 &
h)
\parbox[t][2cm][c]{2cm}{
