...
Três irmãos vão repartir uma barra de chocolate. Um deles sugere a seguinte divisão: 
  ...
  \begin{center}
    \includegraphics[width=300pt, keepaspectratio]{pngs_licao_01/ativ1_fig01.png}  
  \end{center}
...
\begin{enumerate} [\quad a)] %s
  ...
  \item     Use a imagem a seguir para mostrar uma divisão da barra de chocolate que permita que os 3 irmãos recebam quantidades iguais de chocolate. 
    \begin{center}
    \includegraphics[width=300pt, keepaspectratio]{pngs_licao_01/ativ1_fig02.png}  
  \end{center}
...
Três pizzas inteiras, de mesmo tamanho, foram repartidas entre as crianças de uma turma. Para isso, a turma foi dividida em três grupos com quatro crianças cada. Veja como cada grupo repartiu a sua pizza.
  ...
  \begin{center}
    \includegraphics[width=400pt, keepaspectratio]{pngs_licao_01/ativ2_fig01.png}
    
    \includegraphics[width=300pt, keepaspectratio]{pngs_licao_01/ativ2_fig02.png}  
  \end{center}
...
\begin{center}
    \includegraphics[width=400pt, keepaspectratio]{pngs_licao_01/ativ3_fig01.png}  
  \end{center}
...
\begin{center}
    \includegraphics[width=300pt, keepaspectratio]{pngs_licao_01/orgideias_fig01.png}  
  \end{center}
...
\begin{center}
    \includegraphics[width=400pt, keepaspectratio]{pngs_licao_01/orgideias_fig02.png}  
  \end{center}
...
\begin{center}
    \includegraphics[width=300pt, keepaspectratio]{pngs_licao_01/orgideias_fig03.png}  
  \end{center}
...
\begin{center}
    \includegraphics[width=100pt, keepaspectratio]{pngs_licao_01/orgideias_fig04.png}  
  \end{center}
...
\begin{center}
    \includegraphics[width=400pt, keepaspectratio]{pngs_licao_01/orgideias_fig05.png}  
  \end{center}
...
\begin{refletindo*}[breakable]{}{}  
  ...
  \begin{center}
    \includegraphics[width=380pt, keepaspectratio]{pngs_licao_01/reflet_fig01.png}  
  \end{center}

  \begin{center}
    \includegraphics[width=260pt, keepaspectratio]{pngs_licao_01/reflet_fig02.png}  
  \end{center}
