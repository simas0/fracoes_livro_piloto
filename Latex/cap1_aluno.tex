...
\hline \hline \\ 
\centering \begin{tikzpicture}[scale=3]
...
\centering\begin{tikzpicture}[scale=3]
\draw [fill=common] (0,0) arc (0:90:3) -- (-3,0) -- cycle;
\end{tikzpicture}        &\centering   um terço  &  \\[3ex]
    \hline \\
\centering \begin{tikzpicture}[scale=3]
\draw [fill=common] (0,0) arc (0:90:3) -- (-3,0) -- cycle;
\end{tikzpicture}        & \centering  um quarto  &  \\[5ex]
    \hline \\
\centering \begin{tikzpicture}[scale=3]
...
\draw [fill=common] (0,0) rectangle (3,3);
\end{tikzpicture}
  & \centering  um terço  &  \\[3ex]
    \hline \\
\centering \begin{tikzpicture}[scale=3]
\draw [fill=common] (0,0) rectangle (3,3);
\end{tikzpicture}
 & \centering  um quarto  &  \\[5ex]
    \hline \\
\centering \begin{tikzpicture}[scale=3]
\draw  (0,0) -- (3,3);
\end{tikzpicture}
...
\end{tikzpicture}  & \centering  metade  &  \\ [3ex]
    \hline \\
\centering \begin{tikzpicture}[scale=3]
\draw [fill=common] (0,0) -- (3,0) -- (-1.5,1.5) -- cycle;
\end{tikzpicture}  & \centering  um terço  &  \\[3ex]
