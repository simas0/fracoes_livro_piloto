...
\begin{refletindo*}[breakable]{}{}  
  ...
  \begin{center}
    \includegraphics[width=380pt, keepaspectratio]{../../livro/media/cap1/secoes/pngs_licao_01/reflet_fig01.png}  
  \end{center}

  \begin{center}
    \includegraphics[width=260pt, keepaspectratio]{../../livro/media/cap1/secoes/pngs_licao_01/reflet_fig02.png}  
  \end{center}
