...
\begin{tabular}{ccc}
\includegraphics[width=100px, keepaspectratio]{../../livro/media/cap5/secoes/PNGs_licao_05/ativ1_fig01.png} &\quad \quad&\includegraphics[width=100px, keepaspectratio]{../../livro/media/cap5/secoes/PNGs_licao_05/ativ1_fig02.png}\\
...
\begin{center}
\includegraphics[width=330px, keepaspectratio]{../../livro/media/cap5/secoes/PNGs_licao_05/ativ2_fig01.png}
\end{center}
...
Uma barra de chocolate é vendida com as marcações mostradas na figura abaixo.
 \begin{center}
 \includegraphics[width=150px, keepaspectratio]{../../livro/media/cap5/secoes/PNGs_licao_05/ativ3_fig01.png}
 \end{center}
...
\begin{center}  
  \includegraphics[width=330px, keepaspectratio]{../../livro/media/cap5/secoes/PNGs_licao_05/ativ14_fig01.png}
\end{center}
