...
\begin{imagem*}[breakable]{}{}   FIGURA ARTÍSTICA  
  ...
  Miguel: Minha mãe sabe do que está falando. Hoje no ônibus ela me mostrou frações no painel do motorista, ontem em casa ela mostrou uma seringa e um copo com marquinhas e lá estavam as frações também.  
    ...
    \includegraphics[width=20pt, keepaspectratio]{../../livro/media//cap2/secoes/jarra-de-vidro-graduada-300x199.jpg}  
...
\begin{center}
\includegraphics[width=180pt, keepaspectratio]{../../livro/media//cap2/secoes/copos-de-agua-01.png}
\end{center}
...
\begin{center}
  \begin{tabular}{|m{0.2\textwidth}|m{0.2\textwidth}|m{0.5\textwidth}|}
    ...
    \hline \hline 
     \centering $\dfrac{1}{2}$  &\centering \parbox[c][1.3cm]{1.5cm}{\begin{tikzpicture}
                                    \draw[fill=attention] (0,0) rectangle (12,8);
                                   \end{tikzpicture}}
 &  \\
    \hline
     \centering $\dfrac{4}{2}$  &   \centering \parbox[c][1.3cm]{1.5cm}{\begin{tikzpicture}
                                    \draw[fill=attention] (0,0) rectangle (12,8);
                                   \end{tikzpicture}}
                                   &  \\
    \hline
     \centering $\dfrac{3}{2}$  &  \centering \parbox[c][1.3cm]{1.5cm}{\begin{tikzpicture}
                                    \draw[fill=attention] (0,0) rectangle (12,8);
                                   \end{tikzpicture}}
                                   &  \\
    \hline
     \centering $\dfrac{2}{3}$  &  \centering \parbox[c][1.3cm]{1.5cm}{\begin{tikzpicture}
                                    \draw[fill=attention] (0,0) rectangle (12,8);
                                   \end{tikzpicture}}
                                   &  \\
    \hline
    ...
    \hline
      \centering $\dfrac{2}{3}$  &  \centering \parbox[c][1.3cm]{1.5cm}{\begin{tikzpicture}
                                   ...
                                   \end{tikzpicture}}   &  \\
    \hline
      \centering $\dfrac{1}{2}$  &  \centering \parbox[c][1.3cm]{1.3cm}{\begin{tikzpicture}
                                    \foreach \x in {0,60,...,300}{\draw[color=attention, fill=attention] (\x:5) -- (\x +60:5)--(0,0)--cycle; \draw (\x:5) -- (\x +60:5);}
                                   \end{tikzpicture}}  &  \\
    \hline
%       \centering $\dfrac{4}{2}$  &   \centering \parbox[c][1.3cm]{1.3cm}{\begin{tikzpicture}
%                                     \foreach \x in {0,60,...,300}{\draw[color=attention, fill=attention] (\x:5) -- (\x +60:5)--(0,0)--cycle; \draw (\x:5) -- (\x +60:5);}
%                                    \end{tikzpicture}}  &  \\
%     \hline
%       \centering $\dfrac{3}{2}$  &   \centering \parbox[c][1.3cm]{1.3cm}{\begin{tikzpicture}
%                                     \foreach \x in {0,60,...,300}{\draw[color=attention, fill=attention] (\x:5) -- (\x +60:5)--(0,0)--cycle; \draw (\x:5) -- (\x +60:5);}
%                                    \end{tikzpicture}}  &  \\
%     \hline
%       \centering $\dfrac{2}{3}$  &   \centering \parbox[c][1.3cm]{1.3cm}{\begin{tikzpicture}
%                                     \foreach \x in {0,60,...,300}{\draw[color=attention, fill=attention] (\x:5) -- (\x +60:5)--(0,0)--cycle; \draw (\x:5) -- (\x +60:5);}
%                                    \end{tikzpicture}}  &  \\
%     \hline
  \end{tabular}
