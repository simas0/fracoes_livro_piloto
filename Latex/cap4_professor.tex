...
%{\Large {\bf {Frações Equivalentes e Comparação de Frações }}
...
\noindent 
\begin{tabular}{|m{.126\textwidth}|m{.079\textwidth}|m{.079\textwidth}|m{
.067\textwidth}|}
    \hline
...
$\frac{3}{10}$ \\
      \hline 
       \includegraphics[width=60pt, 
keepaspectratio]{../../livro/media/cap4/secoes/dobradura-02.jpg} &  6 &  20 &  
$\frac{6}{20}$ \\
      \hline 
       \includegraphics[width=60pt, 
keepaspectratio]{../../livro/media/cap4/secoes/dobradura-03.png} &  9 &  30 &  
$\frac{9}{30}$ \\
      \hline 
       \includegraphics[width=60pt, 
keepaspectratio]{../../livro/media/cap4/secoes/dobradura-04.png} &  12 &  40 &  
$\frac{12}{40}$ \\
      \hline 
...
\noindent \begin{tikzpicture}[x=1mm,y=1mm, scale=1.45]
 ...
 \draw[->] (-10,0) -- (-6,0);
 \node[text width=20 mm] at (-8,-10) {Divide-se a unidade em 4 partes iguais.}; 
 ...
 \draw[->] (6,0) -- (10,0);
 \node[text width=20 mm] at (8,-10) {Uma parte corresponde a um quarto.}; 
 ...
 \begin{scope}[xshift=65] 
  \draw[->] (-10,0) -- (-6,0);
 \node[text width=38 mm] at (4,-11.5) {Divide-se cada cópia em 3 partes iguais obtendo 15 cópias de um doze avos.};
...
\noindent \begin{tikzpicture}[x=21mm,y=21mm]
  \draw (0,0) -- (3,0);
  \foreach \x in {0,...,3}{ \draw (\x,-3pt) -- (\x, 3pt);  \node[above] at (\x,3pt) {\x}; }
